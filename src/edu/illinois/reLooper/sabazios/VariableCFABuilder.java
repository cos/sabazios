 ...
 */
public class VariableCFABuilder extends SSAPropagationCallGraphBuilder {

  public VariableCFABuilder(IClassHierarchy cha, AnalysisOptions options, AnalysisCache cache, ContextSelector appContextSelector,
    ...
    contextSelector = new VariableCFAContextSelector(contextSelector);
