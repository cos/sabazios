...
import racefix.jmol.Graphics3D;
...
public interface JmolRendererInterface {
  ...
  public abstract boolean initializeExporter(String type, Viewer viewer, double privateKey, Graphics3D g3d,
      Object output);
  ...
  public abstract void drawBond(Atom atomA, Atom atomB, short colixA, short colixB, byte endcaps, short mad);

  public abstract void fillCylinder(short colixA, short colixB, byte endcaps, int diameter, int xA, int yA, int zA,
  ...
  public abstract void fillCylinderScreen(byte endcaps, int diameter, int xA, int yA, int zA, int xB, int yB, int zB);

  public abstract void fillCylinderScreen(byte endcapsOpenend, int diameter, Point3i pt0i, Point3i pt1i);

  public abstract void fillConeScreen(byte endcap, int screenDiameter, Point3i screenBase, Point3i screenTip,
      boolean isBarb);

  public abstract void fillConeSceen(byte endcap, int screenDiameter, Point3f screenBase, Point3f screenTip);

  public abstract void drawHermite(int tension, Point3i s0, Point3i s1, Point3i s2, Point3i s3);

  public abstract void drawHermite(boolean fill, boolean border, int tension, Point3i s0, Point3i s1, Point3i s2,
      Point3i s3, Point3i s4, Point3i s5, Point3i s6, Point3i s7, int aspectRatio);

  public abstract void fillHermite(int tension, int diameterBeg, int diameterMid, int diameterEnd, Point3i s0,
      Point3i s1, Point3i s2, Point3i s3);

  // isosurface "mesh" option -- color mapped vertices
  public abstract void drawTriangle(Point3i screenA, short colixA, Point3i screenB, short colixB, Point3i screenC,
      short colixC, int check);
  ...
  /*
   * was for stereo -- not implemented public abstract void drawfillTriangle(int xA, int yA, int zA, int xB, int yB, int
   * zB, int xC, int yC, int zC);
   */

  // isosurface colored triangles
  public abstract void fillTriangle(Point3i screenA, short colixA, short normixA, Point3i screenB, short colixB,
      short normixB, Point3i screenC, short colixC, short normixC);

  // polyhedra
  public abstract void fillTriangleTwoSided(short normix, int xScreenA, int yScreenA, int zScreenA, int xScreenB,
  ...
  public abstract void fillQuadrilateral(Point3i screenA, short colixA, short normixA, Point3i screenB, short colixB,
  ...
  public abstract void setNoisySurfaceShade(Point3i screenA, Point3i screenB, Point3i screenC);
  ...
  public abstract void fillEllipsoid(Point3f center, Point3f[] points, int x, int y, int z, int diameter,
  ...
  public abstract boolean drawEllipse(Point3f ptAtom, Point3f ptX, Point3f ptY, boolean fillArc, boolean wireframeOnly);
